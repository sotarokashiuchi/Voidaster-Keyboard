...
uint8_t KeyMapping[LAYER_SIZE][ROW_SIZE][COL_SIZE] = {
  {
    {HID_KEY_NONE, HID_KEY_TAB, HID_KEY_Q, HID_KEY_W, HID_KEY_E, HID_KEY_R, HID_KEY_T},
    {HID_KEY_NONE, HID_KEY_SHIFT_LEFT, HID_KEY_A, HID_KEY_S, HID_KEY_D, HID_KEY_F, HID_KEY_G},
...
uint8_t KeyMapping[LAYER_SIZE][ROW_SIZE][COL_SIZE] = {
  {
    {HID_KEY_Y, HID_KEY_U, HID_KEY_I, HID_KEY_O, HID_KEY_P, HID_KEY_BACKSPACE, HID_KEY_NONE},
    {HID_KEY_H, HID_KEY_J, HID_KEY_K, HID_KEY_L, HID_KEY_NONE, HID_KEY_SHIFT_RIGHT, HID_KEY_NONE},
    {_BLANK_, HID_KEY_N, HID_KEY_M, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_CONTROL_RIGHT, HID_KEY_NONE},
    {HID_KEY_ENTER, HID_KEY_ESCAPE, HID_KEY_NONE, HID_KEY_NONE, _BLANK_, _BLANK_, LAYER(NUMBER)},
  },
  {
    {HID_KEY_Q, HID_KEY_Q, HID_KEY_Q, HID_KEY_Q, },
  },
