...
uint8_t KeyMapping[LAYER_SIZE][ROW_SIZE][COL_SIZE] = {
  {
    { LAYER(SIGN), HID_KEY_TAB, HID_KEY_Q, HID_KEY_W, HID_KEY_E, HID_KEY_R, HID_KEY_T },
    { HID_KEY_CAPS_LOCK, HID_KEY_SHIFT_LEFT, HID_KEY_A, HID_KEY_S, HID_KEY_D, HID_KEY_F, HID_KEY_G },
    { HID_KEY_NONE, HID_KEY_CONTROL_LEFT, HID_KEY_Z, HID_KEY_X, HID_KEY_C, HID_KEY_V, HID_KEY_B },
    { LAYER(NUMBER), _BLANK_, _BLANK_, HID_KEY_NONE, HID_KEY_CAPS_LOCK, HID_KEY_ALT_LEFT, HID_KEY_SPACE },
  },
  {
    { HID_KEY_NONE, HID_KEY_NONE, HID_KEY_1, HID_KEY_2, HID_KEY_3, HID_KEY_4, HID_KEY_5 },
    { HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE },
    { HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE },
    { HID_KEY_NONE, _BLANK_, _BLANK_, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE },
  },
  {
    { HID_KEY_NONE, HID_KEY_NONE, SHIFTED_KEY_EXCLAIM, SHIFTED_KEY_AT, SHIFTED_KEY_HASH, SHIFTED_KEY_DOLLAR, SHIFTED_KEY_PERCENT },
    { HID_KEY_NONE, HID_KEY_NONE, SHIFTED_KEY_COLON, HID_KEY_MINUS, SHIFTED_KEY_DOUBLE_QUOTE, HID_KEY_SLASH, SHIFTED_KEY_UNDERSCORE },
    { HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE },
    { HID_KEY_NONE, _BLANK_, _BLANK_, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE },
  },
  // {
...
uint8_t KeyMapping[LAYER_SIZE][ROW_SIZE][COL_SIZE] = {
  {
    { HID_KEY_Y, HID_KEY_U, HID_KEY_I, HID_KEY_O, HID_KEY_P, HID_KEY_BACKSPACE, HID_KEY_DELETE },
    { HID_KEY_H, HID_KEY_J, HID_KEY_K, HID_KEY_L, HID_KEY_NONE, HID_KEY_SHIFT_RIGHT, HID_KEY_NONE },
    { _BLANK_, HID_KEY_N, HID_KEY_M, HID_KEY_COMMA, HID_KEY_PERIOD, HID_KEY_CONTROL_RIGHT, HID_KEY_NONE },
    { HID_KEY_ENTER, HID_KEY_ESCAPE, HID_KEY_NONE, HID_KEY_NONE, _BLANK_, _BLANK_, LAYER(SIGN) },
  },
  {
    { HID_KEY_6, HID_KEY_7, HID_KEY_8, HID_KEY_9, HID_KEY_0, HID_KEY_NONE, HID_KEY_NONE },
    { HID_KEY_ARROW_LEFT, HID_KEY_ARROW_DOWN, HID_KEY_ARROW_UP, HID_KEY_ARROW_RIGHT, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE },
    { _BLANK_, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE },
    { HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, _BLANK_, _BLANK_, HID_KEY_NONE },
  },
  {
    { SHIFTED_KEY_CIRCUMFLEX, SHIFTED_KEY_AMPERSAND, SHIFTED_KEY_ASTERISK, SHIFTED_KEY_LEFT_PAREN, SHIFTED_KEY_LEFT_CURLY_BRACE, HID_KEY_NONE, HID_KEY_NONE },
    { HID_KEY_NONE, SHIFTED_KEY_QUESTION, HID_KEY_NONE, HID_KEY_BRACKET_LEFT, HID_KEY_SEMICOLON, HID_KEY_NONE, HID_KEY_NONE },
    { _BLANK_, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE },
    { HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, HID_KEY_NONE, _BLANK_, _BLANK_, HID_KEY_NONE },
  },
    // {
